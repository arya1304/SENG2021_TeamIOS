...
class DespatchAdviceFactory :
    ...
    def lambda_handler(event, context):
        ...
        #create the despatch advice
        factory = DespatchAdviceFactory()
        advice = factory.create_despatch_advice(orderAdvice, shipment)

        despatch_item = {
            'ID': advice.cbc_ID, 
            'IssueDate': advice.cbc_IssueDate,
            'CountrySubentity': advice.cac_Shipment.cac_Delivery.cac_DeliveryAddress.cac_Country,
            'DespatchContent': advice.xml
        }

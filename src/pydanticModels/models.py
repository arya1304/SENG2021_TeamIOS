...
# took in sample json despatch advice 
# and created a base pydantic model
...
class CacRequestedDeliveryPeriod(BaseModel):
    cbc_StartDate: Optional[str] = None 
    cbc_StartTime: Optional[str] = None 
    cbc_EndDate: Optional[str] = None 
    cbc_EndTime: Optional[str] = None 

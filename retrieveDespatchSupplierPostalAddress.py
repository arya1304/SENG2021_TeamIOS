...
def lambda_handler(event, context):
    ...
    # Get the SupplierPostalAddress attribute string from the Item associated with ID
    despatch_advice = response['Item']
    supplier_postal_address_xml = despatch_advice.get('SupplierPostalAddress')
    
    #return success: 200 + items
    return {
        "statusCode": 200,
        "Items": supplier_postal_address_xml
    }